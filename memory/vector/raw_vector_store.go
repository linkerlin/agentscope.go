...
func (s *RawVectorStore) Search(ctx context.Context, query string, opts RetrieveOptions) ([]*MemoryNode, error) {
	return nil, nil
}
func (s *RawVectorStore) Get(ctx context.Context, memoryID string) (*MemoryNode, error) {
	return nil, nil
}
